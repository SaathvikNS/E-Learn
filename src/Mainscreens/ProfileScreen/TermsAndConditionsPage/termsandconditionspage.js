    ...
    return(
        <View style={[styles.container, {backgroundColor: darkscheme ? "#181a20" : "#fbfbfb",}]}>
            <View style={[styles.titlecontainer, {borderBottomColor: darkscheme ? "#4360c988" : "#82aae388"}]}>
                ...
                <Text style={[styles.title, {color: darkscheme ? "#4360c9" : "#82aae3", textAlign: "center", width: "95%",}]}>Terms and Conditions</Text>
            </View>
...
<Text style={[styles.content, {color: darkscheme ? "#ffffffcc" : "#5e5e5e", textAlign: "left"}]}>
...
{`These Terms of Use constitute a legally binding agreement made between you, whether personally or on behalf of an entity (“you”) and E-Learn ("Company," “we," “us," or “our”), concerning your access to and use of the E-Learn website as well as any other media form, media channel, mobile website or mobile application related, linked, or otherwise connected thereto (collectively, the “Site”). You agree that by accessing the Site, you have read, understood, and agreed to be bound by all of these Terms of Use. IF YOU DO NOT AGREE WITH ALL OF THESE TERMS OF USE, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SITE AND YOU MUST DISCONTINUE USE IMMEDIATELY.
...
<Text style={[styles.content, {color: darkscheme ? "#ffffffcc" : "#5e5e5e", fontFamily: "FredokaOne-Regular"}]}>
Binding Arbitration
</Text>
<Text style={[styles.content, {color: darkscheme ? "#ffffffcc" : "#5e5e5e",}]}>
