...
import { allFeaturedVideos } from "../../../components/video links/vidlinks";

const AllFeaturedScreen =() => {
    ...
    return(
        <View style={[styles.container, {backgroundColor: darkscheme ? "#181a20" : "#fbfbfb",}]}>
            <View style={[styles.titlecontainer, {borderBottomColor: darkscheme ? "#4360c988" : "#82aae388"}]}>
                ...
                <Text style={[styles.title, {color: darkscheme ? "#4360c9" : "#82aae3", textAlign: "center", width: "95%",}]}>Featured Courses</Text>
            </View>
            <ScrollView showsVerticalScrollIndicator={false}>
                <View style={styles.contentwrapper}>
                    {
                        allFeaturedVideos.map((items) => {
                            return(
...
export default AllFeaturedScreen;